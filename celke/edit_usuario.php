                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="senha" type="password" class="form-control" id="senha"
                                placeholder="A senha com mínimo de 6 caracteres"
                                autocomplete="off" value="<?=$senha?>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input name="complemento" type="text" class="form-control" id="complemento"
                                ...
                                autocomplete="off" value="<?=$complemento?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <input name="login" type="text" class="form-control" id="login"
                                placeholder="Insira um login" autocomplete="off" value="<?=$login?>">
                        </div>
                        <div class="form-group col-md-2">
