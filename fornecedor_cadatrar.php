                ...
                <form action="fornecedor_include.php" method="GET">
                    <div class="form-row">
                         ...
                         <div class="form-group col-md-4">
                            ...
                            <input name="idFornecedor" type="text" class="form-control" id="idFornecedor" placeholder="idFornecedor" required>
                        </div>
                    </div>
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label>CNPJ</label>
                                <input name="cnpjFornecedor" type="text" class="form-control" id="cnpjFornecedor" placeholder="cnpjFornecedor">
